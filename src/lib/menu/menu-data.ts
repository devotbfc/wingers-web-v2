 ...
 * with a `dataTodo: "price"` or `dataTodo: "both"` marker MUST be swapped with real
 * numbers before launch (grep for `dataTodo:` to find them all).
 *
 ...
 *
 * Buttermilk-brined items MUST include "milk" and "gluten" in `allergens`.
 * This is a food-safety data model.
 */
...
export const MENU: readonly MenuItem[] = [
  ...
  // — BURGERS —
  {
    ...
    allergens: ["milk", "gluten", "eggs", "mustard"],
    spiceLevel: 2,
    isHalal: true,
    isSignature: true,
